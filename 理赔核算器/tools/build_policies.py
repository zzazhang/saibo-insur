...
CHUBB = {
    ...
    "coverage": {
        ...
        "items": {
            ...
            # —— 监管罚款：本保单的标志性观察点 ——
            "R1-04": {"status": "nominal_only", "clause": "第三条第九、三十八款 监管程序罚金",
                      "note": "条款将监管机构作出的金钱性质罚款和处罚写入损害赔偿范围，"
                              "但附「**在法律和赔偿支付地允许承保的前提下**」这一限定语。"
                              "该句式与赎金条款的「在中国法律允许范围内」同构。"
    ...
    "settlement_notes": [
        "**监管罚款是本保单的标志性观察点**：条款把行政罚款写入损害赔偿范围，"
        "但加了「在法律和赔偿支付地允许承保的前提下」。这与赎金条款的"
        "「在中国法律允许范围内」是同一种句式——国际条款移植入境时保留了"
        "本国不可执行的责任项，靠一句限定语把风险推回给投保人。"
        "本项目把这类情形统一标为 nominal_only，正是为了让这种落差在数字上显形。",
